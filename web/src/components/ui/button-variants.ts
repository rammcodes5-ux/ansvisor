...
// Kept in its own module (NOT 'use client') so server components can call
// buttonVariants() for link styling. Re-exporting it from the 'use client'
// button.tsx would taint it as a client reference and crash on the server.
